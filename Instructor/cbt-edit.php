...
if (
    ...
    $title = "Studycology - Instructors (Edit CBT question)";
    include "inc/header.php";
    include "inc/navbar.php";
?>  
    <div class="container my-4">
        <form action="action/add-cbt.php" class="border p-3 p-sm-5">
            <h4>Edit CBT Question</h4>
            <div class="mb-3">
                <label for="chapterSelect" class="form-label">Select Subject <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <label for="examyear" class="form-label">Select Exam Type <span class="text-danger">*</span></label>
                <select class="form-select" id="examyear" name="examtype" required disabled>
                    <option value="utme">UTME</option>
                </select>
            </div>
            <div class="mb-3">
                <label for="subject" class="form-label">Select Exam Year <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <label for="question" class="form-label">Enter Question <span class="text-danger">*</span></label>
            ...
            <div class="mb-3" >               
                <label class="form-label mt-3">Options <span class="text-danger">*</span></label>
            ...
            <div class="my-3">
                <span>Set Active Status</span>
                <div class="form-check form-switch">
                    <!-- <label class="form-check-label" for="status"></label> -->
                    <input class="form-check-input" type="checkbox" id="status">
                </div>
            </div>
            <button type="submit" class="btn btn-primary">Update CBT Question</button>
        </form>
    </div>
